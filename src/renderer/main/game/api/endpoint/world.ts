...
export function fetchWorldInstance(location: string) {
...
export function fetchWorldInstanceShortName(location: string) {
...
export function fetchWorldInstanceFromShortName(shortName: string) {
  return api<ApiWorldInstance>({
    method: ApiRequestMethod.GET,
